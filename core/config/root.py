"""WeaveConfig — root configuration aggregating all sub-configs."""
...
from core.config.env import _CLAUDE_ENV, _get_non_interactive_env
from core.config.llm import LLMConfig, ModelRoutingConfig
from core.config.timeout import NodeTimeoutConfig, WatchdogConfig
