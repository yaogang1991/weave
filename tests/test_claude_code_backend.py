...
class TestClaudeCodeBackendConstruction:
    def test_backend_name(self):
        from agent.backends.claude_code import ClaudeCodeBackend, ClaudeCodeConfig
        backend = ClaudeCodeBackend(config=ClaudeCodeConfig())
...
class TestClaudeCodeBackendExecuteCLI:
    ...
    def test_cli_file_not_found(self):
        from agent.backends.claude_code import ClaudeCodeBackend, ClaudeCodeConfig
        cfg = ClaudeCodeConfig(cli_path="/nonexistent/claude")
...
class TestClaudeCodeBackendBuildCLICommand:
    def _backend(self, **kwargs):
        from agent.backends.claude_code import ClaudeCodeBackend, ClaudeCodeConfig
        return ClaudeCodeBackend(config=ClaudeCodeConfig(**kwargs))
...
class TestClaudeCodeBackendErrorClassification:
    def _backend(self):
        from agent.backends.claude_code import ClaudeCodeBackend, ClaudeCodeConfig
        return ClaudeCodeBackend(config=ClaudeCodeConfig())
